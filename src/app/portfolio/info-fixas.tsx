        ...
        >
          <ul className="mt-16 w-max">
            ...
            {/* <li>
              ...
              >
                <span className={`nav-indicator mr-4 h-px transition-all group-hover:w-16 group-hover:bg-slate-200 ${
                  activeId === "projetos" ? "w-16 bg-slate-200" : "w-8 bg-slate-600"
                }`} />
                <span className={`nav-text text-xs font-bold uppercase tracking-widest group-hover:text-slate-200 ${
                  activeId === "projetos" ? "text-slate-200" : "text-slate-500"
                }`}>
                  Projetos
                </span>
              </ScrollLink>
      ...
      <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
        <li className="mr-5 shrink-0 text-xs">
          <Link
            ...
            href="https://github.com/Marcos-GC-Ramos"
            target="_blank"
        ...
        <li className="mr-5 shrink-0 text-xs">
          <Link
            className="block hover:text-slate-200"
            href="https://www.linkedin.com/in/marcos-ramos-3740441b8/"
            target="_blank"
            rel="noreferrer noopener"
